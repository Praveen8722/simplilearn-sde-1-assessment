...
export default function FeatureHighlight() {
  const { featureHighlight } = landingPageData;
    ...
    >
      <div className="mx-auto flex max-w-[1200px] flex-col items-center gap-10 md:flex-row md:gap-16 lg:gap-20">
        ...
        <div className="flex w-full justify-center md:w-[40%]">
          <img
            src="https://faheemonhub.github.io/Nexcent-Figma/assets/Frame%2035.svg"
        ...
        <div className="w-full md:w-[60%]">
          ...
          <div className="mt-8">
            <Button
              label={featureHighlight.button.label}
              href={featureHighlight.button.href}
            />
          </div>
        </div>
      </div>
